  ...
  return (
    ...
    >
      ...
      <div className="flex-1 mt-10 lg:mt-0 flex justify-center">
        <div className="relative w-72 h-72 md:w-96 md:h-96 rounded-full bg-gradient-to-tr from-blue-500 via-cyan-400 to-purple-500 p-[7px] shadow-[0_0_50px_rgba(500,180,246,0.6)]">
          <img
            src={Profile}
            alt="Hero"
